...
const CombatOverlay: React.FC = () => {
    ...
    const p_hpPercent = (player.stats.hp / player.stats.maxhp) * 100;
    const p_manaPercent = (player.stats.mana / player.stats.maxmana) * 100;

    const e_hpPercent = (enemy.stats.hp / enemy.stats.maxhp) * 100;
    const e_manaPercent = (enemy.stats.mana / enemy.stats.maxmana) * 100;
          ...
          <div className="flex flex-col w-2/3 overflow-y-auto bg-gray-800 rounded-xl p-6 text-gray-200 cursor-default select-none">
            ...
            <div className="flex items-center justify-between gap-3">
              <p className="text-base font-medium">
                Health: {enemy.stats.hp} / {enemy.stats.maxhp}
              </p>
            ...
            <div className="flex items-center justify-between gap-3 mb-1">
              <p className="text-base font-medium">
                Mana: {player.stats.mana} / {playerDataManager.calcMaxMana(player)}
              </p>
              <div className="w-[70%] h-2 bg-gray-600 rounded-full overflow-hidden">
                <div
                  className="h-full bg-cyan-500 rounded-full transition-all duration-300"
